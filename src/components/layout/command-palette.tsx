...
export function CommandPalette() {
  ...
  const commands: CommandItem[] = [
    ...
    },
    {
      ...
      path: '/article',
      keywords: ['articles', 'post'],
    },
    {
      id: 'comment-keyword',
      label: t('nav.commentKeyword'),
    ...
    },
    {
      ...
      label: t('nav.platformPermission'),
                ...
                {filtered.length === 0 ? (
                  ...
                  filtered.map((item, index) => (
                    ...
                    >
                      <span
                        className={cn(
                          index === selectedIndex ? 'text-primary-500' : 'text-neutral-400',
                        )}
                      >
                        {item.icon}
                      </span>

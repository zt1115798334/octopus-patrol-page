  ...
  ({ className, hover = false, glass = false, padding = 'default', children, ...props }, ref) => (
    <div
      ...
      className={cn(
        ...
        !glass &&
          'hover:shadow-[0_8px_24px_-6px_rgba(0,0,0,0.06),0_2px_8px_-2px_rgba(0,0,0,0.03)] hover:border-neutral-300/80 dark:hover:border-neutral-700/80',
...
const CardTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn(
        'text-base font-semibold leading-none tracking-tight text-neutral-900 dark:text-neutral-50',
        className,
      )}
      {...props}
    />

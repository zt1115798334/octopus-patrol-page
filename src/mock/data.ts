...
export const mockUsers: UserDto[] = [
  {
    ...
    avatarId: 1,
    phone: '13800000001',
    enabledState: 'ENABLED' as any,
    createdTime: daysAgo(60),
    lastLoginTime: daysAgo(0),
    planName: '企业版',
    planLevel: 'ENTERPRISE' as any,
    roleIds: [1],
  },
  {
    id: 2,
    ...
    phone: '13800000002',
    enabledState: 'ENABLED' as any,
    createdTime: daysAgo(55),
    lastLoginTime: daysAgo(2),
    planName: '专业版',
    planLevel: 'PROFESSIONAL' as any,
    roleIds: [2],
  },
  {
    id: 3,
    ...
    phone: '13800000003',
    enabledState: 'ENABLED' as any,
    createdTime: daysAgo(50),
    lastLoginTime: daysAgo(3),
    planName: '基础版',
    planLevel: 'BASIC' as any,
    roleIds: [2],
  },
  {
    id: 4,
    ...
    phone: '13800000004',
    enabledState: 'ENABLED' as any,
    createdTime: daysAgo(45),
    lastLoginTime: daysAgo(5),
    planName: '专业版',
    planLevel: 'PROFESSIONAL' as any,
    roleIds: [2],
  },
  {
    ...
    avatarId: 5,
    phone: '13800000005',
    enabledState: 'DISABLED' as any,
    createdTime: daysAgo(40),
    lastLoginTime: daysAgo(10),
    planName: '基础版',
    planLevel: 'BASIC' as any,
    roleIds: [3],
  },
  ...
  },
  {
    ...
    phone: '13800000008',
    enabledState: 'ENABLED' as any,
    createdTime: daysAgo(25),
    lastLoginTime: daysAgo(4),
    planName: '基础版',
    planLevel: 'BASIC' as any,
    roleIds: [3],
  },
...
export const mockPlatforms: PlatformDto[] = [
  {
    id: 1,
    platformName: '小红书',
    platformCode: 'XHS' as any,
    description: '小红书平台爬取与评论',
    enabledState: 'ENABLED' as any,
    createdTime: daysAgo(180),
    updatedTime: daysAgo(1),
  },
  {
    id: 2,
    platformName: '抖音',
    platformCode: 'DY' as any,
    description: '抖音短视频平台',
    enabledState: 'ENABLED' as any,
  ...
  },
  {
    id: 3,
    platformName: '微博',
    platformCode: 'WB' as any,
    description: '微博社交媒体平台',
    enabledState: 'ENABLED' as any,
    createdTime: daysAgo(120),
    updatedTime: daysAgo(5),
  },
  {
    id: 4,
    platformName: '知乎',
    platformCode: 'ZH' as any,
    description: '知乎问答平台',
    enabledState: 'DISABLED' as any,
    createdTime: daysAgo(90),
    updatedTime: daysAgo(10),
  },
  {
    id: 5,
    platformName: 'B站',
    platformCode: 'BILI' as any,
    description: 'Bilibili弹幕视频网',
    enabledState: 'ENABLED' as any,
    createdTime: daysAgo(60),
...
export const mockPlatformSchemes: PlatformSchemeDto[] = [
  {
    ...
    platformCode: 'XHS' as any,
    platformAccountId: 1,
    requestParams: '{"keyword":"热门话题"}',
    description: '每日热门话题爬取',
    enabledState: 'ENABLED' as any,
    createdTime: daysAgo(60),
    updatedTime: daysAgo(1),
  },
  ...
  },
  {
    ...
    platformCode: 'BILI' as any,
    platformAccountId: 6,
    requestParams: '{"type":"trending"}',
    description: 'B站热门视频监控',
    enabledState: 'ENABLED' as any,
    createdTime: daysAgo(10),
    updatedTime: daysAgo(0),
  },
  {
    ...
    platformCode: 'XHS' as any,
    platformAccountId: 8,
    requestParams: '{"keyword":"数码"}',
    description: '数码产品评测监控',
    enabledState: 'ENABLED' as any,
    createdTime: daysAgo(5),
    updatedTime: daysAgo(1),
  },
...
export const mockMenus: MenuDto[] = [
  {
    ...
    sort: 1,
    children: [],
    meta: { icon: 'LayoutDashboard', title: '仪表盘' },
  },
  {
    id: 2,
    parentId: 0,
...
export const mockPricingPlans: PricingPlanDto[] = [
  ...
  },
  {
    id: 5,
    planName: '旗舰版',
    planLevel: 'ULTIMATE' as any,
    originalPrice: 9999,
    discountPrice: 6999,
    keywordLimit: 9999,
    dailyCommentLimit: 9999,
    aiConfigLimit: 200,
    tokenLimit: 999999,
    enabledState: 'DISABLED' as any,
    createdTime: daysAgo(100),
    updatedTime: daysAgo(50),
  },
]
...
export const mockPlanHistory: UserPricingPlanHistoryDto[] = [
  {
    ...
    aiConfigLimit: 50,
    tokenLimit: 100000,
    usedKeywordCount: 120,
    usedCommentCount: 800,
    usedAiConfigCount: 20,
    usedTokenCount: 30000,
  },
  {
    id: 2,
    userId: 2,
  ...
  },
  {
    ...
    aiConfigLimit: 50,
    tokenLimit: 100000,
    usedKeywordCount: 200,
    usedCommentCount: 1200,
    usedAiConfigCount: 30,
    usedTokenCount: 50000,
  },
]
...
export const mockArticles: ArticleDto[] = [
  {
    id: 1,
    title: '2025年AI行业发展趋势报告',
    url: 'https://xhs.com/article/1',
  ...
  },
  {
    id: 3,
    title: '前端框架性能对比2025',
    url: 'https://zhihu.com/article/3',
    publishTime: daysAgo(7),
  ...
  },
  {
    id: 4,
    title: '微服务架构最佳实践',
    url: 'https://zhihu.com/article/4',
    publishTime: daysAgo(8),
  ...
  },
  {
    id: 5,
    title: 'Python自动化运维实战',
    url: 'https://xhs.com/article/5',
    publishTime: daysAgo(9),
  ...
  },
  {
    id: 6,
    title: '云原生技术栈选型指南',
    url: 'https://zhihu.com/article/6',
    publishTime: daysAgo(10),
    createdTime: daysAgo(10),
    updatedTime: daysAgo(10),
  },
  {
    id: 7,
    title: '大模型微调技术详解',
    url: 'https://xhs.com/article/7',
    publishTime: daysAgo(11),
  ...
  },
  {
    id: 8,
    title: '数据仓库架构演进之路',
    url: 'https://zhihu.com/article/8',
    publishTime: daysAgo(12),
  ...
  },
  {
    id: 9,
    title: 'Rust在系统编程中的优势',
    url: 'https://xhs.com/article/9',
    publishTime: daysAgo(13),
    createdTime: daysAgo(13),
    updatedTime: daysAgo(13),
  },
  {
    id: 10,
    title: '容器编排技术对比：K8s vs Nomad',
    url: 'https://zhihu.com/article/10',
  ...
  {
    id: 11,
    title: 'TypeScript 5.0新特性解读',
    url: 'https://xhs.com/article/11',
    publishTime: daysAgo(15),
    createdTime: daysAgo(15),
    updatedTime: daysAgo(15),
  },
  {
    id: 12,
    title: '数据库性能优化实战指南',
    url: 'https://zhihu.com/article/12',
    publishTime: daysAgo(16),
    createdTime: daysAgo(16),
    updatedTime: daysAgo(16),
  },
]
...
export const mockLogs: LogDto[] = [
  ...
  },
  {
    ...
    name: '李四',
    type: 'BUSINESS',
    operate: 'DELETE' as any,
    content: '删除评论关键词：测试',
    ip: 3232235900,
    createdTime: daysAgo(2),
    classify: '关键词管理',
    func: 'deleteCommentKeyword',
    timeConsuming: 30,
  },
  {
    id: 6,
  ...
  },
  {
    ...
    type: 'BUSINESS',
    operate: 'UPDATE' as any,
    content: '运行方案#2：热门视频监控',
    ip: 3232235777,
    createdTime: daysAgo(4),
    classify: '方案管理',
    func: 'runPlatformScheme',
    timeConsuming: 3500,
  },
  {
    id: 11,
...
export const mockJobs: JobDto[] = [
  {
    jobName: 'dailyHotTopicCrawl',
    jobGroup: 'platform',
    jobClassName: 'com.octopus.job.DailyHotTopicJob',
    cronExpression: '0 0 8 * * ?',
    description: '每日热门话题爬取任务，每天8点执行',
  },
  {
    jobName: 'commentAutoReply',
    jobGroup: 'platform',
    jobClassName: 'com.octopus.job.CommentAutoReplyJob',
    cronExpression: '0 */30 * * * ?',
    description: '自动评论回复任务，每30分钟执行',
  },
  {
    jobName: 'tokenRefresh',
    jobGroup: 'system',
    jobClassName: 'com.octopus.job.TokenRefreshJob',
    cronExpression: '0 0 */2 * * ?',
    description: '平台账号Token刷新，每2小时执行',
  },
  {
    jobName: 'dailyReport',
    jobGroup: 'system',
    jobClassName: 'com.octopus.job.DailyReportJob',
    cronExpression: '0 30 9 * * ?',
    description: '每日运营报告生成，每天9点30分执行',
  },
  {
    jobName: 'dataCleanUp',
    jobGroup: 'system',
    jobClassName: 'com.octopus.job.DataCleanUpJob',
    cronExpression: '0 0 2 * * ?',
    description: '历史数据清理任务，每天凌晨2点执行',
  },
  {
    jobName: 'keywordTrendAnalysis',
    jobGroup: 'platform',
    jobClassName: 'com.octopus.job.KeywordTrendAnalysisJob',
    cronExpression: '0 0 12 * * ?',
    description: '关键词趋势分析任务，每天12点执行',
  },
]

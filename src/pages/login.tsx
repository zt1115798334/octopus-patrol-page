...
import { Bot, Eye, EyeOff, Monitor, Moon, Sparkles, Sun } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { Input } from '@/components/ui/input'
import { getPublicKey, login as loginApi } from '@/api/modules/auth'
import { useAuthStore, useSettingStore, useThemeStore } from '@/stores'
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          type="button"
                          onClick={() =>
                            setThemeStyle(themeStyle === 'anime' ? 'default' : 'anime')
                          }
                          className={cn(

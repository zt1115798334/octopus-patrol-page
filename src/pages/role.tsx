...
import {
  changeRoleEnabledState,
  deleteRole,
  deleteRoles,
  findRolePage,
  saveRole,
} from '@/api/modules/role'
import type { EnabledState, QueryRoleDto, RoleDto } from '@/types'
...
export default function RoleManagement() {
  ...
  const handleCreate = useCallback(() => {
    setEditing(null)
    form.reset({ name: '', sort: 0, enabledState: 'ON' })
    setDialogOpen(true)
  }, [form])
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="relative flex-1 max-w-sm">
              ...
              <Input
                ...
                onKeyDown={(e) =>
                  e.key === 'Enter' && queryClient.invalidateQueries({ queryKey: ['roles'] })
                }
              />
            </div>
            <Button
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>{t('role.sort')}</TableHead>
